...
- **Every post closes with a follow CTA** — weekly Issues and daily Field Notes both end with a follow/subscribe line ([@itsalreadywhen](https://x.com/itsalreadywhen) or RSS), so a post is never a dead end
